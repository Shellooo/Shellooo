...
class ViewController: UIViewController {
    ...
    override func motionEnded(_ motion: UIEventSubtype, with event: UIEvent?)
    {
        if event?.subtype == UIEventSubtype.motionShake
        {
            ...
            let shellShakeQuotes=["Sure, be my guest","AS IF!","Make it happen","Yassssss","Eww","I'm not quite sure how to help you with that","You don't have to ask me for permission","If you have to ask...","Yes, go","I'm not going to judge","Yes, please","Hurry up, go!","You're so pretty…the answer is yes","Yes!","I can't give you the green light on that"]
